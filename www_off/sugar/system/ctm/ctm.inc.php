...
######################################################################################################################
    case 'lobby':
        ...
        $box->angle_in('10','270','402','50',"$server->color_admin",'black','','','100',"Ajouter un contrat de maintenance",'',"");	
            if($sugar->security_ctm>1)
                {
            ...
            else echo"<center>Acces admin requis</center>";
        $box->angle_out("");

        $box->angle_in('420','30','802','800','white','black','','','100',"Contrat de maintenance",'',"");	
