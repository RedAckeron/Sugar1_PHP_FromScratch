...
##########################################################################################
	public function select_option_disabled($name,$value,$actuel)
		{
        //echo("<option value=''disabled>$name</option>");
        if (($value==$actuel)and($actuel!=''))echo("<option value='$value' disabled selected>*$name</option>");
		else echo("<option value='$value' disabled>$name</option>");
		}
##########################################################################################
...
##########################################################################################
	public function upload_file($name,$url_in,$url_out,$size_file)
		{
		echo "<form enctype='multipart/form-data' action='$url_in&url_out=$url_out' method='post'>
