...
######################################################################################################################
	case 'lobby':
        ...
        $form->open("index.php?system=user&sub_system=edit_user","POST");
...
######################################################################################################################
	case 'edit_user':
        ...
        $box->angle_in('20','20','400','250','','black','','',100,"Information utilisateur","",'');
            //login
            $box->angle('','','149','25','','','','',100,"Login :","",'');
            $box->angle_in('','','249','25','','','','',100,"","",'');
            echo $form->text_disabled("","",$user->login);
            $box->angle_out('');
            //password
            $box->angle('','','149','25','','','','',100,"Password :","",'');
            $box->angle_in('','','249','25','','','','',100,"","",'');
            ...
            $box->angle_out('');
            //nom
            $box->angle('','','149','25','','','','',100,"Nom :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
            echo $form->text("nom","","$user->nom");
            $box->angle_out('');
            //prenom
            $box->angle('','','149','25','','','','',100,"Prenom :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
            echo $form->text("prenom","","$user->prenom");
            $box->angle_out('');
            //email
            $box->angle('','','149','25','','','','',100,"Email :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
            echo $form->text("email","","$user->email");
            $box->angle_out('');
            //call1
            $box->angle('','','149','25','','','','',100,"Call 1 :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
            echo $form->text("call1","","$user->call1");
            $box->angle_out('');
            //call2
            $box->angle('','','149','25','','','','',100,"Call 2 :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
            echo $form->text("call2","","$user->call2");
            $box->angle_out('');
            
            //shop
            $box->angle('','','149','25','','','','',100,"Shop :","",'');
            $box->angle_in('','','199','25','','','','',100,"","",'');
        ...
        $box->angle_out('');
			...
			$box->angle_in('480','20','250','340','orange','black','','',100,"Security Acces","",'');
			...
			//help
				...
				$box->angle_out('');
			$box->angle_out('');
			$box->angle_in('350','770','95','25','red','','','',100,"","",'');
